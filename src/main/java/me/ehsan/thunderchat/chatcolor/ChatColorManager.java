...
public final class ChatColorManager {
    ...
    public boolean canUse(Player player) {
        return player.hasPermission("thunderchat.chatcolor");
    }
    ...
    public String getColor(Player player) {
        return colors.getOrDefault(player.getUniqueId(), "white");
    }
    ...
    public String colorize(Player player, String message) {
        ...
        Component component = miniMessage.deserialize("<" + color + ">" + MiniMessage.miniMessage().escapeTags(message) + "</" + color + ">");
    ...
    private void load() {
        ...
        for (String raw : yaml.getConfigurationSection("players").getKeys(false)) {
            try {
                ...
                colors.put(uuid, yaml.getString("players." + raw, "white"));
