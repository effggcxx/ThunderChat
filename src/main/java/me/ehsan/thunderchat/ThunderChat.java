...
public final class ThunderChat extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ChatListener(this), this); getServer().getPluginManager().registerEvents(new SpyListener(this), this); getServer().getPluginManager().registerEvents(new SpyInputListener(this), this); getServer().getPluginManager().registerEvents(new PlayerStateListener(this), this); getServer().getPluginManager().registerEvents(new InteractiveChatListener(this), this);
    ...
    private void registerInteractivePermissions() {
        registerPermission("thunderchat.interactive.*", "Allows every ThunderChat interactive chat feature", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.item", "Allows using the [item] and [i] chat placeholders", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.inventory", "Allows using the [inv] and [inventory] placeholders", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.ender", "Allows using the [ender] and [e] placeholders", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.player", "Allows interactive player-name hover/click handling", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.commands", "Allows interactive command links", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.position", "Allows the [pos] placeholder", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.ping", "Allows the [ping] placeholder", PermissionDefault.TRUE);
        registerPermission("thunderchat.interactive.custom.*", "Allows every configured custom interactive placeholder", PermissionDefault.FALSE);
        registerPermission("thunderchat.interactive.custom", "Allows configured custom interactive placeholders", PermissionDefault.FALSE);
    }
